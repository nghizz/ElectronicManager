...
<head>
    ...
    .content {
        background-color: #f8f9fa; /* Màu nền nội dung chính */
        padding: 20px;
        margin-top: 20px;
        border-radius: 5px;
    }
    ...
    .card {
        ...
        background-color: white; /* Màu nền của card */
    }
    .card:hover {
    ...
    .btn-success {
        background-color: #28a745; /* Màu nút Mua ngay */
        border-color: #28a745;
    }
    .btn-success:hover {
        background-color: #218838; /* Màu khi hover nút Mua ngay */
        border-color: #218838;
    }
    .btn-info {
        background-color: #17a2b8; /* Màu nút Thêm vào giỏ hàng */
        border-color: #17a2b8;
    }
    .btn-info:hover {
        background-color: #138496; /* Màu khi hover nút Thêm vào giỏ hàng */
        border-color: #138496;
    }
</style>
            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<a href='cart.php?action=add&id=" . $row["id"] . "' class='btn btn-success'>Mua ngay</a>";
                        echo "<a href='cart.php?action=add&id=" . $row["id"] . "' class='btn btn-info'>Thêm vào giỏ hàng</a>";
